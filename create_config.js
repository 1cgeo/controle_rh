...
const createConfig = async () => {
  try {
    console.log('Sistema de Controle de RH API Rest'.blue)
    ...
    const questions = [
      ...
      },
      {
        ...
        name: 'dbUser',
        message:
          'Qual o nome do usuário do PostgreSQL para interação com o SCRH (já existente no banco de dados e ser superusuario)?',
      ...
      },
      {
        ...
        mask: '*',
        message:
          'Qual a senha do usuário do PostgreSQL para interação com o SCRH?'
      },
      {
        type: 'input',
        name: 'dbName',
        message: 'Qual o nome do banco de dados do SCRH?',
        default: 'controle_rh'
      },
      {
        type: 'input',
      ...
      },
      {
        type: 'confirm',
        name: 'dbCreate',
        message: 'Deseja criar o banco de dados do SCRH?',
        default: true
      },
      {
        type: 'input',
      ...
      },
      {
        ...
        name: 'authUser',
        message:
          'Qual o nome do usuário já existente Serviço de Autenticação que será administrador do SCRH?'
      },
      {
        type: 'password',
        name: 'authPassword',
        mask: '*',
        message:
          'Qual a senha do usuário já existente Serviço de Autenticação que será administrador do SCRH?'
      }
    ]
    ...
    if (dbCreate) {
      ...
      console.log(
        'Banco de dados do Sistema de Controle de RH criado com sucesso!'.blue
      )
    } else {
