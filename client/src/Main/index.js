...
import CalendarioPessoal from '../CalendarioPessoal'
import CalendarioGeral from '../CalendarioGeral'
      ...
      <HashRouter>
        ...
        <main className={classes.content}>
          ...
          <Container maxWidth='xl' className={classes.container}>
            ...
            <Route exact path='/calendario_pessoal' component={CalendarioPessoal} />
            <PrivateRoute role='ADMIN' exact path='/dashboard' component={Dashboard} />
            <PrivateRoute role='ADMIN' exact path='/calendario_geral' component={CalendarioGeral} />
            <PrivateRoute role='ADMIN' exact path='/tabela_semanal' component={TabelaSemanal} />
